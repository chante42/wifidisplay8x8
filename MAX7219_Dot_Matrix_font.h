...
const byte MAX7219_Dot_Matrix_font_default [256] [8]    = {
  ...
  { 0x70, 0x78, 0x4C, 0x46, 0x4C, 0x78, 0x70, 0x00 }, // 0x7F 127
  { 0x0E, 0x9F, 0x91, 0xB1, 0xFB, 0x4A, 0x00, 0x00 }, // 0x80 128
  { 0x3A, 0x7A, 0x40, 0x40, 0x7A, 0x7A, 0x40, 0x00 }, // 0x81 129 
  { 0x38, 0x7C, 0x54, 0x55, 0x5D, 0x19, 0x00, 0x00 }, // 0x82 130 é
  { 0x02, 0x23, 0x75, 0x55, 0x55, 0x7D, 0x7B, 0x42 }, // 0x83 131 
  { 0x21, 0x75, 0x54, 0x54, 0x7D, 0x79, 0x40, 0x00 }, // 0x84 132 
  { 0x21, 0x75, 0x55, 0x54, 0x7C, 0x78, 0x40, 0x00 }, // 0x85 133 à
  { 0x20, 0x74, 0x57, 0x57, 0x7C, 0x78, 0x40, 0x00 }, // 0x86 134
  { 0x18, 0x3C, 0xA4, 0xA4, 0xE4, 0x40, 0x00, 0x00 }, // 0x87 135 ç
  { 0x02, 0x3B, 0x7D, 0x55, 0x55, 0x5D, 0x1B, 0x02 }, // 0x88 136 ê
  { 0x39, 0x7D, 0x54, 0x54, 0x5D, 0x19, 0x00, 0x00 }, // 0x89 137 
  { 0x39, 0x7D, 0x55, 0x54, 0x5C, 0x18, 0x00, 0x00 }, // 0x8A 138 è
...
const byte MAX7219_Dot_Matrix_SINCLAIR_font [256] [8]    = {
    {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}, // 0x00
    ...
    {0x00, 0x38, 0x54, 0x54, 0x54, 0x48, 0x00, 0x00}, // 0x82 130 é remplacé par e
    {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}, // 0x83 131 
    {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}, // 0x84 132 
    {0x00, 0x20, 0x54, 0x54, 0x54, 0x78, 0x00, 0x00}, // 0x85 133 à remplacé par a
    {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}, // 0x86 134
    {0x00, 0x00, 0x38, 0x44, 0x44, 0x44, 0x00, 0x00}, // 0x87 135 ç remplacé par c
    {0x00, 0x38, 0x54, 0x54, 0x54, 0x48, 0x00, 0x00}, // 0x88 136 ê remplacé par e
    {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}, // 0x89 137 
    {0x00, 0x38, 0x54, 0x54, 0x54, 0x48, 0x00, 0x00}, // 0x8A 138 è remplacé par e
...
const byte MAX7219_Dot_Matrix_6pix_font [256] [5]   =  {
  ...
  {0x24, 0x2a, 0x7f, 0x2a, 0x12}, // 0x2, 0x004 $
  ...
  {0x38, 0x54, 0x54, 0x54, 0x18}, // 0x82 130 é remplacé par e
  {0x00, 0x00, 0x00, 0x00, 0x00}, // 0x83 131 
  {0x00, 0x00, 0x00, 0x00, 0x00}, // 0x84 132 
  {0x20, 0x54, 0x54, 0x54, 0x78}, // 0x85 133 à remplacé par a
  {0x00, 0x00, 0x00, 0x00, 0x00}, // 0x86 134
  {0x38, 0x44, 0x44, 0x44, 0x20}, // 0x87 135 ç remplacé par c
  {0x38, 0x54, 0x54, 0x54, 0x18}, // 0x88 136 ê remplacé par e
  {0x00, 0x00, 0x00, 0x00, 0x00}, // 0x89 137 
  {0x38, 0x54, 0x54, 0x54, 0x18}, // 0x8A 138 è remplacé par e
